...
Bokuchi's user interface is available in 14 languages. The default language is English. You can change it in [Settings](/guides/settings/) > Interface > Language.
