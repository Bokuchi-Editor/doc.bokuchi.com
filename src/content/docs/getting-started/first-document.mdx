...
2. **Type some text**
   ...
   <img src={imgTyping.src} alt="Typing Markdown in the editor" width="700" />
...
3. **Check the preview**
   ...
   <img src={imgPreview.src} alt="Editor and preview side by side" width="700" />
...
4. **Save your document**
   ...
   <img src={imgSave.src} alt="Save dialog" width="700" />
</Steps>
