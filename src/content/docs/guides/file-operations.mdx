...
<img src={imgRecent.src} alt="Recent files dialog with search, preview, and path copy" width="700" />
...
<img src={imgChange.src} alt="File change detection dialog asking whether to reload" width="700" />
