...
| Mode | Description |
|------|-------------|
| Editor to Preview (default) | Scrolling the editor scrolls the preview. Scrolling the preview does not move the editor. |
| Bidirectional | Scrolling either pane scrolls the other. |
